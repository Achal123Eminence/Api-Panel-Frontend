...
@Component({
  selector: 'app-betfair-all-match-soccer',
  imports: [RouterModule, CommonModule,FormsModule],
  templateUrl: './betfair-all-match-soccer.html',
  styleUrl: './betfair-all-match-soccer.css'
})
export class BetfairAllMatchSoccer implements OnInit {
  ...
  ngOnInit(): void {
    this.fetchCricketAllEventList('1');
  }
  ...
  fetchCricketAllEventList(id: any) {
    ...
    this.apiService.getAllEvents(id).subscribe({
      next: (res: any) => {
        ...
        this.showToast('Soccer All Event list fetched successfully');
